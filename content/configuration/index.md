...
`imgBgColorLightMode` | CSS color string | Sets the default background color for `<img>` tags on light mode | no
`imgBgColorDarkMode` | CSS color string | Sets the default background color for `<img>` tags on dark mode | no
